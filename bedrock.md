...
To use this library with [Amazon Bedrock's OpenAI-compatible Responses API](https://docs.aws.amazon.com/bedrock/latest/userguide/models-api-compatibility.html), use the `BedrockOpenAI`
...
`BedrockOpenAI` only exposes the Responses API. Other SDK surfaces fail before sending a request.
